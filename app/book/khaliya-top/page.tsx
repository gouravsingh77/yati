...
export default function BookingPage() {
  ...
  const trek = {
    ...
    image: "/placeholder.svg?height=400&width=600&text=Khaliya+Top",
    category: "Easy Trek",
    duration: "2 Days",
    difficulty: "Easy",
        ...
        <div className="max-w-md mx-auto text-center">
          ...
          <div className="space-y-4">
            <Button asChild className="w-full">
              <Link
                href="https://wa.me/919259071008?text=I've%20made%20the%20payment%20for%20my%20Khaliya%20Top%20Trek%20booking.%20Here's%20my%20screenshot."
                target="_blank"
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <label
                            ...
                            className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                          >
                            Photography service (₹3,000 for the entire trek)
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
