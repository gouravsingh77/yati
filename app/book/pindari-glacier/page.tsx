...
export default function BookingPage() {
  ...
  const trek = {
    ...
    description: "Trek to one of the most accessible glaciers in the Kumaon Himalayas",
    image: "/placeholder.svg?height=400&width=600&text=Pindari+Glacier",
        ...
        <div className="max-w-md mx-auto text-center">
          ...
          <div className="space-y-4">
            <Button asChild className="w-full">
              <Link
                href="https://wa.me/919259071008?text=I've%20made%20the%20payment%20for%20my%20Pindari%20Glacier%20Trek%20booking.%20Here's%20my%20screenshot."
                target="_blank"
              ...
              <Card>
                ...
                <CardFooter className="flex flex-col">
                  ...
                  <Button asChild variant="outline" size="sm" className="w-full">
                    <Link
                      href="https://wa.me/919259071008?text=I'm%20interested%20in%20the%20Pindari%20Glacier%20Trek.%20Can%20you%20provide%20more%20information?"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <svg
