...
export default function BookingPage() {
  ...
  const trek = {
    ...
    description: "Trek to the sacred temple of Lord Shiva, hidden in the Garhwal Himalayas",
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (formData.puja) totalAmount += 2500 * parseInt(formData.participants)
      if (formData.photography) totalAmount += 4000
      ...
      const emailContent = `
        ...
        Puja Arrangements: ${formData.puja ? 'Yes' : 'No'}
        ...
        ${formData.puja ? `Puja Arrangements: ₹2,500 x ${formData.participants} = ₹${(2500 * parseInt(formData.participants)).toLocaleString()}\n` : ''}
        ${formData.photography ? `Photography: ₹4,000\n` : ''}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox 
                            ...
                            onCheckedChange={(checked) => handleSelectChange('puja', checked)}
                          />
                          <label
                            htmlFor="puja"
                            className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <label
                            ...
                            className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                          >
                            Photography service (₹4,000 for the entire trek)
                          </label>
                        </div>
                      </div>
                    </div>
              ...
              <Card>
                ...
                <CardFooter className="flex flex-col">
                  ...
                  <Button asChild variant="outline" size="sm" className="w-full">
                    <Link
                      href="https://wa.me/919259071008?text=I'm%20interested%20in%20the%20Rudranath%20Trek.%20Can%20you%20provide%20more%20information?"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <svg
