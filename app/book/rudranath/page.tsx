...
export default function BookingPage() {
  ...
  const trek = {
    ...
    image: "/placeholder.svg?height=400&width=600&text=Rudranath",
        ...
        <div className="max-w-md mx-auto text-center">
          ...
          <div className="space-y-4">
            <Button asChild className="w-full">
              <Link
                href="https://wa.me/919259071008?text=I've%20made%20the%20payment%20for%20my%20Rudranath%20Trek%20booking.%20Here's%20my%20screenshot."
                target="_blank"
